    ...
    for _ in word_input:
        try:
            ...
            if char in cyrillic_letters:
                ...
                word += char  # Если символ не кириллический, оставляем как есть
...
# Маршрут для обработки шифрования (AJAX-запрос)
...
def encrypt():
    ...
    encrypted_word = encrypt_word(word_input)  # Шифруем слово
